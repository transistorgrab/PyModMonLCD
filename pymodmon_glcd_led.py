...
class LED(object):
    def __init__(self):
        ...
        self.led_data   = ([0x00,0x00]) ## contains data to send to LED shift register
    ...
    def set_led(self, color, level):
        ...
        if (color == 'green'):
            tmp_greens       = self.led_data[1]             ## saves backlight led status
    ...
    def display(self):
        ...
        self.spi_led.xfer2(self.led_data,3900000,10,8)    ## list of data, xfer speed, us delay, bits per word
        self.spi_led.close()
...
class GLCD(object):
    def __init__(self):
        ...
        self.lcd_image_data = [0]*(self.width*(self.height/8)) ## contains the datastream to send to the LCD
    ...
    def convert_image(self, image):
        ...
        self.lcd_image = [0]*(image.size[0]*(image.size[1]/8)) # contains the datastream to send to the LCD
...
led.display()
print "setting backlight finished"
